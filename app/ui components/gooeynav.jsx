...
const GooeyNav = ({
  ...
  const [activeIndex, setActiveIndex] = useState(() => {
    ...
    const indexFromPath = items.findIndex(item => item.href === pathname);
    return indexFromPath !== -1 ? indexFromPath : initialActiveIndex;
  });
  ...
  useEffect(() => {
    ...
    if (indexFromPath !== -1 && indexFromPath !== activeIndex) {
      ...
      const activeLi = navRef.current?.querySelectorAll("li")[indexFromPath];
      if (activeLi) {
        updateEffectPosition(activeLi);
      }
    }
